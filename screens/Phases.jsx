      ...
      <div style={{ maxWidth: '680px', margin: '0 auto', padding: '40px 20px' }}>
        <div className="fade-up">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '28px' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '5px' }}>
                <span style={{ fontSize: '9px', color: '#888' }}>{activeIdx + 1} / {selected.length}</span>
          ...
          <div style={{ marginBottom: '22px' }}>
            ...
            <h2 style={{ fontSize: '20px', fontWeight: 700, color: '#ffffff', marginTop: '8px', letterSpacing: '-0.02em' }}>
              {activeConfig.label}
            </h2>
            <p style={{ fontSize: '10px', color: '#888', marginTop: '3px' }}>{activeConfig.sub}</p>
          </div>
    ...
    <div style={{ maxWidth: '680px', margin: '0 auto', padding: '40px 20px' }}>
      <div className="fade-up">
        <div style={{ marginBottom: '28px' }}>
          <p style={{ fontSize: '9px', color: '#888', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '6px' }}>
            step 2 / 2
          </p>
          <h2 style={{ fontSize: '22px', fontWeight: 700, color: '#ffffff', letterSpacing: '-0.02em' }}>
            Fill in your life phases
          </h2>
          <p style={{ fontSize: '10px', color: '#888', marginTop: '4px', lineHeight: 1.7 }}>
            ...
            return (
              <button key={ph.id}
                ...
                style={{
                  ...
                  padding: '12px 14px',
                  borderRadius: '10px',
                  border: `1px solid ${active ? '#1e1e1e' : '#141414'}`,
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <p style={{ fontSize: '9px', color: '#444', marginTop: '2px' }}>{ph.sub}</p>
                    </div>
