    ...
    <div style={{ maxWidth: '780px', margin: '0 auto', padding: '40px 20px' }}>
      <div className="fade-up">
        ...
        <div style={{
          ...
          <div>
            <p style={{ fontSize: '9px', color: '#888', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '4px' }}>
              lifeplot
            </p>
        ...
        <div style={{
          ...
          {[
            ...
            <CardAccent key={label} style={{ textAlign: 'center', padding: '14px 10px' }}>
              <p style={{ fontSize: '9px', color: '#555', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '5px' }}>
                {label}
              </p>
              <p style={{ fontSize: '17px', fontWeight: 700, color: '#ffffff' }}>{val}</p>
            </CardAccent>
          ))}
        </div>
        ...
        <Card style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div>
            <p style={{ fontSize: '11px', color: '#ffffff', fontWeight: 600, marginBottom: '4px' }}>
              Export & Import
            </p>
            <p style={{ fontSize: '9px', color: '#888', lineHeight: 1.7 }}>
          ...
          <CardAccent>
            <p style={{ fontSize: '9px', color: '#555', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '8px' }}>
              How to import
            </p>
            {[
              ...
              <p key={step} style={{ fontSize: '10px', color: '#888', lineHeight: 2.0 }}>{step}</p>
            ))}
          </CardAccent>
